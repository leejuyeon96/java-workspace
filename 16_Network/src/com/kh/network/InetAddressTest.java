 ...
 * -DNS(Domain Name System)를 통해 해당 도메인 IP주소를 알아낼 수 있다.  
 * 
 * 포트(Port)
 * - IP 주소는 네트워크 상에서 컴퓨터를 찾을 때만 사용하고 컴퓨터 내에서 실행하는 프로그램을 선택하기 위해 포트를 사용
 * - 클라이언트는 서버 연결 요청 시 IP 주소와 포트 번호를 알고 있어야한다.
