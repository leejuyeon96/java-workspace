 ...
 * -자바에서 API는 프로그램 개발에 자주 사용되는 클래스및 인터페이스의 모음
 * 
 * 
 * java.lang 패키지
...
public class A_String {
	...
	public void method2() {
		...
		//	-문자열에서 old 문자를 new 문자로 변경된 새로운 문자열을 생성해서 리턴합니다.
		...
		//8. toCharArray() : char[] 
		//	-문자열의 문자들을 문자 배열에 담아서 해당 배열의 주소값을 리턴
	 ...
	 * -StringBuilder와 StringBuffer 의 차이점 : 동기화가 되느냐 안 되느냐
	...
	public void method3() {
			...
			//기본생성자를 통해서 객체를 생성하면 16개의 문자를 저장할 수 있는 버퍼가 생성
			...
			//StringBuilder 클래스의 생성자에 문자열을 전달해주면 문자열 크기 + 16만큼의 버퍼가 생성
