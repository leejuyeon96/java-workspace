 ...
 * -기본 자료형으로 사용해도 되지만 해당 기본 타입을 객체로 취급해서 처리해야하는 경우 사용한다. 
 * -Boxing : 기본 자료형을 Wrapper 클래스로 포장해주는 것
 * -UnBoxing : Wrapper 클래스를 기본자료형으로 변경해주는 것
 * 
 */
...
public void method1() {
	...
	//2. 객체를 생성하지 않고 정적 메서드(valueOf)를 통한 방법
	...
	//자바1.9 버전 이후로는 Boxing, UnBoxing 기능 안쓰도록 Deprecated 되어 있음
...
public void method2() {
	...
	//Wrapper 클래스에서 제공하는 valueOf().toString() 메서드를 사용하는 방법-0
