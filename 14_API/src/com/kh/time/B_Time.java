...
public class B_Time {
	...
	public void method1() {
		...
		System.out.println("isBefore : " + now.isBefore(plusDays)); //오늘이 해당날짜보다 이전인가?
	...
	public void method2() {
		...
		System.out.println("months : " + pe.getDays());
		System.out.println("months : " + pe.get(ChronoUnit.DAYS));
	
		pe = pe.plusYears(3).multipliedBy(2); //3년 더하고 2배 곱한다
