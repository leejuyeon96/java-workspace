...
public class Application {
	 ...
	 * -객체지향 프로그래밍 특성을 지원하는 언어를 객체 지향 프로그래밍 언어라고 한다.
	 * -코드의 재사용성이 높고, 유지보수가 용이하다.
	 * 
	 * 객체 지향 프로그래밍의 특징
	 * 1. 추상화 : 객체들이 가진 공통의 특성들을 파악하고 불필요한 특성들을 제거하는 과정
	 * 2. 캡슐화 : 개체의 속성(필드)와 기능(메소드)을 하나로 묶고 실제 구현 내용을 감추는 것
	...
	public static void main(String[] args) {
		...
		System.out.println("TV상태 : "+ tv.power); //false
	    tv.power();
	    System.out.println("TV상태 : "+ tv.power); //true
	    
	    System.out.println("TV채널 : "+ tv.channel); //20
