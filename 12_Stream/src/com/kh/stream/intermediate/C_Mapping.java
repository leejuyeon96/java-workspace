...
public class C_Mapping {
	...
	public void method1() {
		List<Student> students = Arrays.asList(
				new Student("김민수", 18, "남자", 80, 70), new Student("구관원", 12, "남자", 90, 50),
				new Student("임지우", 16, "여자", 80, 90), new Student("박승환", 11, "남자", 70, 100));
	...
	//asDoubleStream() : IntStream, LongStream 을 DoubleStream 으로 변환
	public void method3() {
